...
const AdminProfile = ({ headingText = "Users Management" }) => {
  ...
  // console.log(user);
  return (
    <div className="flex items-center justify-between sticky top-0 md:top-2  w-full md:w-full px-0 md:px-6 py-8 md:py-4 gap-2 bg-white rounded-md shadow z-20">
      {/* Left dynamic text */}
