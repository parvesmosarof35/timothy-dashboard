...
const Role = () => {
  ...
  return (
    <div className="px-6 mx-auto font-sans">
      ...
      <div className="mt-6  mx-auto bg-gray-50 min-h-screen">
        {/* Header */}
        <div className="bg-white pt-6 rounded-lg shadow-sm px-6 mb-6">
          <h1 className="text-2xl font-bold text-gray-900 mb-6">All Admin</h1>
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <button
              ...
              className="ml-4 bg-[#FFD69B] hover:bg-yellow-500  px-4 py-2 rounded-lg flex items-center gap-2 transition-colors"
            >
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-bold text-gray-900">Make Admin</h2>
                <button
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-[#FFD69B] hover:bg-yellow-500 py-2 px-4 rounded-lg transition-colors font-medium"
                >
                  Submit
                </button>
              </div>
