...
const UserMessage = () => {
  ...
  const ticketData = {
    ...
    assignedAgent: {
      name: 'Sonal Gupta',
      username: '@sonal123',
      avatar: 'https://www.shutterstock.com/image-vector/man-character-face-avatar-glasses-260nw-562077406.jpg'
    },
    requester: {
      name: 'Sonal Gupta',
      username: '@sonal123',
  ...
  const messages = [
    ...
    },
    {
      ...
      time: 'Today 11:52',
      hasImage: true,
      imageUrl: 'https://www.lexus.co.nz/content/dam/lexus-v3-new-zealand/discover-lexus/future-concept-cars/lf-zl-concept.jpg'
    },
    {
      id: 4,
      type: 'agent',
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-lg font-semibold text-gray-800">
                Query: <span className="font-normal">Cannot access the system</span>
  ...
  <div className="flex-1 overflow-y-auto p-4 space-y-4">
      ...
      {messages.map((msg) => (
        ...
        >
          <div className={`max-w-md ${msg.type === "user" ? "ml-auto" : "mr-auto"}`}>
            <div
      ...
      <div className="w-80 bg-white border-l border-gray-200 p-6">
        ...
        <div className="mb-8">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-sm text-gray-800">{ticketData.created}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-sm text-gray-600">Last message:</span>
              <span className="text-sm text-gray-800">{ticketData.lastMessage}</span>
            </div>
            <div className="flex justify-between">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-semibold text-gray-800">Assigned to</h2>
          ...
          <div className="flex items-center space-x-3">
            ...
            />
            <div>
              <p className="text-sm font-medium text-gray-800">{ticketData.assignedAgent.name}</p>
              <p className="text-xs text-gray-500">{ticketData.assignedAgent.username}</p>
            </div>
          </div>
        </div>
        ...
        {/* Requester Detail */}
        <div>
          <h2 className="text-lg font-semibold text-gray-800 mb-4">Requester Detail</h2>
          <div className="flex items-center space-x-3">
            <img 
            ...
            />
            <div>
              <p className="text-sm font-medium text-gray-800">{ticketData.requester.name}</p>
              <p className="text-xs text-gray-500">{ticketData.requester.username}</p>
            </div>
          </div>
        </div>
      </div>
